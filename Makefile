...
mock: 
	mockgen -package mockdb -destination db/mock/store.go github.com/mkarimi-s/bank/db/sqlc Store

.PHONY: postgres createdb dropdb migrateup migratedown sqlc test psql server mock
